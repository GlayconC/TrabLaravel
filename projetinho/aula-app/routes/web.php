...
Route::get('/produto/edit/{id}', 
    'App\Http\Controllers\ProdutosController@editar');     

Route::put('/produto_update/{id}', 
...
Route::get('/cidades/edit/{id}', 
    'App\Http\Controllers\CidadeController@editar');     

Route::put('/cidades_update/{id}', 
    'App\Http\Controllers\CidadeController@update'); 
